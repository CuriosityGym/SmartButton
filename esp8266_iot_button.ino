...
const char* IFTTT_KEY= "bEJ04i0uriNNFOfaM9QrAf"; //Rupin
    
const char* IFTTT_EVENT = "IOT-BUTTON";
const char* IFTTT_NOTIFICATION_EVENT = "IOT-BUTTON";
...
// Button Functions //
//////////////////////
void triggerButtonEvent(String eventName, int eventCount)
{
